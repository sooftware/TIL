...
public class DivideFunctionInstance {
	public static void main(String[] args) {
		int[][] gwamok=new int[3][7];
		char[][] grade=new char[3][7];
		char[][] NAME=new char[7][10];
		
		DivideFunctionInstance DFI = new DivideFunctionInstance();
		
		
		DFI.input(NAME,gwamok);
		DFI.grade(gwamok,grade);
		DFI.output(NAME,grade);
	}
	/////////////////////////////////////////////
	public void input(char[][] NAME,int[][] gwamok){
		int i=0,j=0,k=0;
	...
	///////////////////////////////////////////////
	public void grade(int[][] gwamok,char[][] grade){
		int i=0,j=0;
	...
	////////////////////////////////////////////////
	public void output(char[][] NAME,char[][] grade){
		int i=0,j=0,k=0;
		for(j=0;j<7;j++){
			for(i=0;i<3;i++){
